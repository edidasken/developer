...
const ICONS = {
  ...
  prayer: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-8a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8"/><path d="M4 16s.5-1 2-1 2.5 2 4 2 2.5-2 4-2 2.5 2 4 2 2-1 2-1"/><path d="M2 8.5c0-.28.22-.5.5-.5H3a2 2 0 0 0 2-2V3"/><path d="M7 3v3a2 2 0 0 0 2 2"/><path d="M22 3v3a2 2 0 0 1-2 2h-.5a.5.5 0 0 0-.5.5"/><path d="M17 3v3a2 2 0 0 1-2 2"/></svg>',
...
export function mountUnityFooter(host, cfg = {}) {
  ...
  const actions = [
    ...
    { id: 'prayer', label: 'Prayer',      icon: ICONS.prayer, href: prayerHref },
  ];
