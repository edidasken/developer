/* ══════════════════════════════════════════════════════════════════════════════
  ...
  export function _newServicePlan() {
  ...
  export function _editSermon(id) {
  ...
  export function _editServicePlan(id) {
  ...
  export function _editMinistry(id) {
  ...
  export function _editVolunteer(id) {
  ...
  export async function _sermonSeries() {
    _panel(_spinner());
    try {
